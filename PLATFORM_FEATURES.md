...
- 各モード共通: 上のコンテンツ窓（動画/写真/絵文字）・中心の大型ボタン・バッジの3か所どこを押してもアクションが始まる
- 7日進捗ドット、モード別Tips、動画ローテーション（10秒毎・クロスフェード、スクワット/腕立て/ランジ/レッグレイズ/バーピー）
...
- フォーム動画（MP4、AVPlayerLooperでハードウェアデコード再生。スクワット・腕立て・ランジ・レッグレイズ・バーピー）
