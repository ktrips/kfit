...
export const LoginView: React.FC<LoginViewProps> = ({ onOpenBooks }) => {
    ...
    <div className="min-h-screen bg-duo-gray-light flex flex-col items-center justify-center px-4 py-10">
      ...
      <div className="w-full max-w-sm mt-10">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="text-lg font-black text-duo-dark">関連書籍を読む</h2>
        </div>
        <div className="flex flex-col gap-3">
          {/* AppleWatch Diet */}
          <button
            onClick={onOpenBooks}
            className="group text-left bg-white rounded-2xl p-4 border-2 border-green-300 hover:border-green-500 hover:shadow-md transition-all"
          >
            <div className="flex items-start gap-3">
              <span className="text-3xl shrink-0">⌚</span>
              <div className="flex-1 min-w-0">
                <p className="font-black text-green-700 text-sm leading-snug">
                  AppleWatch Diet Ultra2
                </p>
                <p className="text-xs text-gray-500 mt-0.5 line-clamp-2">
                  Apple Watch Ultra 2を使ったダイエット・健康管理の100メソッドを解説
                </p>
              </div>
              <span className="text-green-400 group-hover:translate-x-1 transition-transform shrink-0">→</span>
            </div>
          </button>
          ...
          <button
            onClick={onOpenBooks}
            className="group text-left bg-white rounded-2xl p-4 border-2 border-blue-300 hover:border-blue-500 hover:shadow-md transition-all"
          >
            <div className="flex items-start gap-3">
              <span className="text-3xl shrink-0">📱</span>
              <div className="flex-1 min-w-0">
                <p className="font-black text-blue-700 text-sm leading-snug">
                  Cursor + Claude で iOS アプリを作る
                </p>
                <p className="text-xs text-gray-500 mt-0.5 line-clamp-2">
                  週末だけで iPhone・Apple Watch アプリを個人開発した全工程
                </p>
              </div>
              <span className="text-blue-400 group-hover:translate-x-1 transition-transform shrink-0">→</span>
            </div>
          </button>
        </div>
