    ...
    <div className="min-h-screen bg-duo-gray-light pb-10">
      <div className="max-w-md mx-auto px-4 pt-6 space-y-5">
        ...
        <button
          ...
          className="w-full bg-white rounded-2xl p-4 text-left flex items-center gap-3 active:scale-[0.98] transition-transform"
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <p className="font-black text-duo-dark text-sm">📱 iOSアプリを取得</p>
            <p className="text-xs font-bold text-duo-gray">Apple Watch連携・モーションセンサーで本格トレーニング</p>
          </div>
